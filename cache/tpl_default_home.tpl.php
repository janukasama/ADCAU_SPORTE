...
<td valign="top">
    ...
    <tr>
        <td class="titTable4"><?php echo ((isset($this->_rootref['L_NAY_01'])) ? $this->_rootref['L_NAY_01'] : ((isset($MSG['NAY_01'])) ? $MSG['NAY_01'] : '{ L_NAY_01 }')); ?></td>
    </tr>
    <tr>
        <td class="table2">
...
<?php } if ($this->_rootref['B_NEWS_BOX']) {  ?>
    ...
    <div class="smallpadding">
		...
		<a href="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>viewallnews.php"><?php echo ((isset($this->_rootref['L_341'])) ? $this->_rootref['L_341'] : ((isset($MSG['341'])) ? $MSG['341'] : '{ L_341 }')); ?></a>
    </div>   
<?php } ?>
	</td>
</tr>
